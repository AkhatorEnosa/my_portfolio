...
function App() {
  ...
  return (
    <div className="mx-auto min-h-screen max-w-[1800px] px-6 py-12 font-sans md:px-36 lg:px-12 md:py-16 lg:py-0 bg-[#f9fafb] dark:bg-[#1F2937] text-[#000000] dark:text-[#f9fafb]">
