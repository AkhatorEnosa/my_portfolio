...
const ServiceCard = ({ title, desc, tech, icon, index }: ServiceCardProps) => {
  return (
    ...
    >
        <div className="flex items-center justify-center w-14 h-14 rounded-2xl text-[#008080] dark:text-blue-400 bg-[#008080]/5 dark:bg-blue-900/20 group-hover:scale-110 transition-transform duration-300">
